...
export default function Services() {
  return (
    <>
    <div className="" style={{backgroundColor : '#EEEEEE'}} id="services">
    <div className="container pb-5">
  <div className="row justify-content-center">
    <div className="col-12">
      <div className="section-title text-center mb-4 pb-2 pt-5">
        <h1 className="title mb-4">Our Services</h1>
  ...
  <div className="row">
      ...
      <div className="card service-wrapper rounded border-0 shadow p-4">
        <div className="icon text-center text-custom h1 shadow rounded bg-white">
          <span className="uim-svg" style={{}}>
            {/* <svg
              xmlns="https://uploads-ssl.webflow.com/62458251a5559067512bba0b/6254320c2dec976c11e5bc5d_Group%20798.svg"
              viewBox="0 0 24 24"
              width="1em"
            >
              <rect
            ...
            <img src='https://uploads-ssl.webflow.com/62458251a5559067512bba0b/625431ff23e5c3f990e912ee_Group%20787.svg' alt=""/>
          </span>
        </div>
        <div className="content mt-4">
          <h5 className="title">POS</h5>
          <p className="text-muted mt-3 mb-0">
          An end-to-end, web-based POS that has everything you need to manage your restaurant or cafe
          </p>
          <div className="mt-3">
          </div>
        </div>
    ...
    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
      <div className="card service-wrapper rounded border-0 shadow p-4">
        <div className="icon text-center text-custom h1 shadow rounded bg-white">
          <span className="uim-svg" style={{}}>
          <img src='https://uploads-ssl.webflow.com/62458251a5559067512bba0b/6254320c2dec976c11e5bc5d_Group%20798.svg' alt="" />
          </span>
        </div>
        <div className="content mt-4">
          <h5 className="title">Order Management</h5>
          <p className="text-muted mt-3 mb-0">
          Accept new orders and process it seamlessly with our order management service
          </p>
          <div className="mt-3">
          </div>
        </div>
    ...
    <div className="col-lg-4 col-md-6 col-12 mt-4 pt-2">
      <div className="card service-wrapper rounded border-0 shadow p-4">
        ...
        <div className="content mt-4">
          <h5 className="title">Minimalism Feast</h5>
          <p className="text-muted mt-3 mb-0">
        ...
        <div className="icon text-center text-custom h1 shadow rounded bg-white">
          <span className="uim-svg" style={{}}>
            ...
            >
              ...
              <polygon
                className="uim-primary"
                points="20 14 20 21 4 17 4 14 20 14"
              />
              <path
                className="uim-primary"
